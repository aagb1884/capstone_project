...
@Profile("!test")
    ...
    public class DataLoader implements ApplicationRunner {
        ...
        public void run(ApplicationArguments args) {
            ...
            Illustrator tazzyman = new Illustrator("Dave", "Tazzyman", "imgurl", "David Tazzyman grew up in Leicester. He likes football, cricket, biscuits, music and drawing. He dislikes celery and changing nappies.");
            illustratorRepository.save(tazzyman);

            Author klassen = new Author("Jon", "Klassen", "imgurl", "Jon Klassen is the New York Times bestselling author and illustrator of several books, including I Want My Hat Back and This Is Not My Hat, for which he won the Caldecott Medal.");
            authorRepository.save(klassen);

            Illustrator iKlassen = new Illustrator("Jon", "Klassen", "imgurl", "Jon Klassen is the New York Times bestselling author and illustrator of several books, including I Want My Hat Back and This Is Not My Hat, for which he won the Caldecott Medal.");
            illustratorRepository.save(iKlassen);

            Author shendra = new Author("Sue", "Hendra", "imgurl", "Sue Hendra grew up in Wimbledon and has always loved making up stories and drawing pictures. In 2006 she met Paul Linnet and could instantly see that she’d met a fellow nitwit who liked talking nonsense.");
            authorRepository.save(shendra);
            Illustrator ishendra = new Illustrator("Sue", "Hendra", "imgurl", "Sue Hendra grew up in Wimbledon and has always loved making up stories and drawing pictures. In 2006 she met Paul Linnet and could instantly see that she’d met a fellow nitwit who liked talking nonsense.");
            illustratorRepository.save(ishendra);
            Author plinnet = new Author("Paul", "Linnet", "imgurl", "Paul Linnet was born in Brighton and grew up in the Midlands, reading Tintin and playing classic 80s video games, before becoming obsessed with scribbling, writing, guitars and motorcycles.");
            authorRepository.save(plinnet);
            Illustrator iplinnet = new Illustrator("Paul", "Linnet", "imgurl", "Paul Linnet was born in Brighton and grew up in the Midlands, reading Tintin and playing classic 80s video games, before becoming obsessed with scribbling, writing, guitars and motorcycles.");
            ...
            Author nshireen = new Author("Nadia", "Shireen", "imgurl", "Nadia Shireen enjoyed making homemade magazines and comics as a child. Her debut book Good Little Wolf received a mention in the Bologna Ragazzi Opera Prima Award and won the UKLA Book Award.");
            authorRepository.save(nshireen);
            Illustrator inshireen = new Illustrator("Nadia", "Shireen", "imgurl", "Nadia Shireen enjoyed making homemade magazines and comics as a child. Her debut book Good Little Wolf received a mention in the Bologna Ragazzi Opera Prima Award and won the UKLA Book Award.");
            illustratorRepository.save(inshireen);
            Illustrator mOrdonez = new Illustrator("Miguel", "Ordonez", "imgurl", "Miguel Ordóñez lives in Madrid and works in his own studio, where he combines graphic design with illustrating projects as well as teaching visual communication and creativity.");
            ...
            Book hatback = new Book("I Want My Hat Back", "A bear's hat has gone. And he wants it back.", 40,Format.PAPERBACK, "04/10/2012", "Walker Books Ltd", "9781406338539", "url.com", null);
